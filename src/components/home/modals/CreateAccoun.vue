...
export default {
    ...
    methods: {
        ...
        register() {
            ...
            const bookList = {
                coldLeaseAddress: new LRUCache(10),
                hotLeaseAddress: new LRUCache(10),
                coldPayAddress: new LRUCache(10),
                hotPayAddress: new LRUCache(10)
            }
            window.localStorage.setItem(this.seed.address, JSON.stringify(savedInfo))
            window.localStorage.setItem(this.seed.address + 'book', JSON.stringify(bookList))
            // console.log(window.localStorage.getItem(this.seed.address))
